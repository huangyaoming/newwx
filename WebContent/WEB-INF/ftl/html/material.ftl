...
.icons {
	background:
		url(http://res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icons.png)
		no-repeat 0 0;
	border-radius: 5px;
	height: 25px;
	overflow: hidden;
...
.icons.arrow-r {
	background:
		url(http://res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/brand_profileinweb_arrow@2x.png)
...
a.activity-meta:active .icon_link_arrow {
	background: transparent
		url(http://res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/link_arrow_right_blue.png)
		no-repeat 0 0;
...
.icon_arrow_gray {
	...
	height: 7px;
	background: transparent
		url(http://res.wx.qq.com/mmbizwap/zh_CN/htmledition/images/icon_arrow_gray.png)
		no-repeat 0 0;
	-webkit-background-size: 100%;
	-moz-background-size: 100%;
	-o-background-size: 100%;
		...
		<div class="header">
			...
			<p class="activity-info">
				...
				<a href="javascript:viewProfile();" id="post-user" class="activity-meta"> 
					<span class="text-ellipsis">汤臣倍健</span>
