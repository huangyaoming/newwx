package com.byhealth.common.bean.restful;
...
import com.byhealth.common.utils.WeChatUtil;
...
public class BaiduMusicServiceApi {
	...
	private static final Logger logger = Logger.getLogger(BaiduMusicServiceApi.class);
	...
	public static Music searchMusic(String musicTitle, String musicAuthor){
		...
		try {
			inputStream = WeChatUtil.httpRequest(requestUrl);
		} catch (Exception e) {
			logger.error("调用百度音乐搜索接口出现异常",e);
		}
