 ...
 * 每日星座运势
 * @author fengjx
 * 接口说明查看：http://api.uihoo.com/demo/astro_day.shtml#body_top
 */
public class LuckServiceApi {
	
	private static final Logger logger = Logger.getLogger(LuckServiceApi.class);
