...
public class MyEmailService {
	 ...
	 * @param mail
	 */
	private static void sendTextMail(SendMailVo mail) {
	 ...
	 */
	private static void sendHtmlMail(SendMailVo mail)	throws MessagingException {
	 ...
	 */
	private static void sendAttrMail(SendMailVo mail) throws MessagingException, UnsupportedEncodingException {
		MimeMessage mailMessage = sender.createMimeMessage();
		// 设置utf-8或GBK编码，否则邮件会有乱码
		MimeMessageHelper messageHelper = new MimeMessageHelper(mailMessage,true);
		messageHelper.setTo(mail.getToUser());// 接受者
