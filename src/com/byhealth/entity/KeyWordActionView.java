...
public class KeyWordActionView {
	...
	public KeyWordActionView(String id, String req_type, String action_type,
			String key_word, Date in_time, String app_id, String bean_name,
			String method_name, String app_name, String material_id,
			String xml_data, String msg_type, String dict_name) {
		super();
		this.id = id;
