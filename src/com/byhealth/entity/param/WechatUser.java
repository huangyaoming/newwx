...
public class WechatUser {
	...
	public WechatUserGroup getWechatUserGroup() {
		...
		wechatUserGroup = (WechatUserGroup) RecordUtil.getEntityFromRecord(
				record, WechatUserGroup.class);
	...
	public WechatPublicAccount getPublicAccount() {
		Record record = Db.findById("wechat_public_account",
				getPublic_account_id());
		publicAccount = (WechatPublicAccount) RecordUtil.getEntityFromRecord(
				record, WechatPublicAccount.class);
		return publicAccount;
	}

	public void setPublicAccount(WechatPublicAccount publicAccount) {
