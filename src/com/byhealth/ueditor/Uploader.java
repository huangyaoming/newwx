...
public class Uploader {
    ...
    public void saeStorageUpload() {
        ...
        try {
            ...
            FileOutputStream outputStream = new FileOutputStream("saestor://yyjwx/" + this.fileName);
            BufferedInputStream bis = new BufferedInputStream(this.inputStream);
